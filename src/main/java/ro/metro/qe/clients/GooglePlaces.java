...
import ro.metro.qe.clients.Place.Location;
...
public class GooglePlaces {
	...
	@Autowired
	public GooglePlaces() {
		this( HttpClientBuilder.create( ).useSystemProperties( ).build( ), "AIzaSyDTdpEwNTXUSKnNgIxI0gtfsMewpWoT5nk" );
	}
    ...
    public PlacesResult searchText(String query,  PlacesQueryOptions options ) {
        ...
        try {
        	...
        	url.addParameter( "key", "AIzaSyDTdpEwNTXUSKnNgIxI0gtfsMewpWoT5nk" );
	...
	public PlacesResult nextPageResults(String pageTocken ) {

		try {
			URIBuilder url = new URIBuilder( TEXT_SEARCH_URL );
			url.addParameter( "key", "AIzaSyDTdpEwNTXUSKnNgIxI0gtfsMewpWoT5nk" );
			url.addParameter( "pagetoken", pageTocken );
